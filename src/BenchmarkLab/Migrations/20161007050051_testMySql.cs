        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    BenchmarkId = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DevicePlatform = table.Column<string>(maxLength: 100, nullable: true),
                    OperatingSystem = table.Column<string>(maxLength: 100, nullable: true),
                    RawUAString = table.Column<string>(maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ExecutionsPerSecond = table.Column<float>(nullable: false),
                    NumberOfSamples = table.Column<int>(nullable: false),
                    RelativeMarginOfError = table.Column<float>(nullable: false),
                    ResultId = table.Column<long>(nullable: false),
                    TestName = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResultRow", x => x.Id);
                    table.ForeignKey(
